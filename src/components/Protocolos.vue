<template>
    <div class="flex flex-col justify-center items-center" >
        ...
        <div class="flex flex-col lg:flex-row justify-center items-center mt-8 mb-12 mx-6">
               ...
               <div class="flex flex-col justify-center items-center w-full">
                    <div class="flex flex-col lg:flex-row items-center justify-start w-full">
                        ...
                        <div class="mr-3">
                            ...
                            <p class="font-normal text-base text-gray-900"><span class="font-bold text-black">Cantidad: </span>{{protocolos.phase1.p1.bottles}}</p>
                            <p class="font-normal text-base text-gray-900 leading-tight"><span class="font-bold text-black">Dosis: </span> {{protocolos.phase1.p1.dose}}.15 minutos antes de cada comida.</p>
                ...
                <div class="flex flex-col justify-center items-center border-t-2 pt-4 w-full" v-show="protocolos.phase1.p2.name.length > 0">
                    <div class="flex flex-col lg:flex-row items-center justify-start w-full">
                        ...
                        <div class="mr-5">
                            ...
                            <p class="font-normal text-base text-gray-700 leading-tight"><span class="font-bold text-black">Dosis:</span> {{protocolos.phase1.p2.dose}}</p>
                            <!--<p class="font-black text-2xl text-graybgcdark pb-0 pt-1">NO DISPONIBLE</p>-->
                            <p class="leading-none font-black text-3xl text-black pb-0 pt-0 mt-3">{{protocolos.phase1.p2.price > 0 ? "$"+protocolos.phase1.p2.price.toFixed(2) : "$29.95" }} <br> <span class="leading-none pt-0 text-sm text-red-600 font-black ml-0 uppercase">**Obtengala gratis por la compra de este producto!</span></p>
                        </div>
                    ...
                    <p class="w-full lg:w-4/5 text-sm mb-3 text-black mt-2 leading-tight"><span class="font-black">Importante:</span> Esta compra cubrirá un período de 120 días dentro de los 180 días sugeridos.</p>
                </div>
                ...
                <a :href="protocolos.phase1.linkPhase1" class="flex flex-row flex-wrap justify-center items-center bg-red-600 w-full lg:w-4/5 mx-auto text-white py-4 rounded-lg mb-5 mt-5 hover:shadow-lg hover:bg-black transition-all font-normal text-xl focus:outline-none"><i class="ri-shopping-cart-2-fill mr-3 text-xl lg:text-2xl"></i>Comprar Ahora!<span class="ml-2 font-bold text-3xl text-center lg:text-lg lg:text-left w-full lg:w-auto lg:text-3xl">${{price1()}}</span></a>
            </div>
            ...
            <div v-if="protocolos.phase2.name != ''" class="flex flex-col justify-around items-start bg-white py-2 px-5 rounded-lg mx-3 mt-5">
                ...
                <div class="flex flex-col justify-center items-center w-full">
                    <div class="flex flex-col lg:flex-row items-center justify-start w-full">
                        ...
                        <div class="mr-3">
                            ...
                            <p class="font-normal text-base text-gray-900"><span class="font-bold text-black">Cantidad: </span>{{protocolos.phase2.p1.bottles}}</p>
                            <p class="font-normal text-base text-gray-900 leading-tight"><span class="font-bold text-black">Dosis: </span>{{protocolos.phase2.p1.dose}}. 15 minutos antes de cada comida.</p>
                            <p class="flex flex-wrap items-center font-black text-3xl text-greenbgc-900 py-2">
                    ...
                    <p class="w-full lg:w-4/5 text-sm mb-3 text-black mt-2 leading-tight"><span class="font-black">Importante:</span> Esta compra cubrirá un período de 30 días dentro de los {{protocolos.phase2.duration}} sugeridos.</p>
                </div>
                ...
                <div class="flex flex-col justify-center items-center border-t-2 pt-4 w-full" v-show="protocolos.phase2.p2.name.length > 0">
                    <div class="flex flex-col lg:flex-row items-center justify-start w-full">
                        ...
                        <div class="mr-5">
                            ...
                            <p class="font-normal text-base text-gray-700 leading-tight"><span class="font-bold text-black">Dosis: </span>{{protocolos.phase2.p2.dose}}</p>
                            <!--<p class="font-black text-2xl text-graybgcdark pb-0 pt-1">NO DISPONIBLE</p>-->
                            <p class="leading-none font-black text-3xl text-black pb-0 pt-0 mt-3">{{protocolos.phase2.p2.price > 0 ? "$"+protocolos.phase2.p2.price.toFixed(2) : "$29.95" }} <br> <span class="leading-none pt-0 text-sm text-red-600 font-black ml-0 uppercase">**Obtengala gratis por la compra de este producto!</span></p>
                        </div>
                        <!--<p class="flex flex-row lg:flex-row justify-center items-center font-normal text-sm bg-graybgcdark text-white border hover:text-white px-0 py-2 lg:px-2 lg:py-1 ml-0 lg:ml-auto transition-all rounded-lg lg:w-auto w-full"><i class="ri-error-warning-line text-base lg:mr-2 mr-2"></i> No Disponible</p>-->
                ...
                <!--Por eso se va a evaluar si existe un producto 3 o no, y en caso no exista no se muestra el elemento-->
                    <div class="flex flex-col justify-center items-center border-t-2 pt-4 w-full" v-show="protocolos.phase2.p3.name.length > 0">
                        <div class="flex flex-col lg:flex-row items-center justify-start w-full">
                            ...
                            <div class="mr-5">
                                ...
                                <p class="font-normal text-base text-gray-700 leading-tight"><span class="font-bold text-black">Dosis:</span> {{protocolos.phase2.p3.dose}}</p>
                                <!--<p class="font-black text-2xl text-graybgcdark pb-0 pt-1">NO DISPONIBLE</p>-->
                    ...
                    <!--<p class="flex flex-row flex-wrap justify-center items-center text-center bg-red-600 w-full lg:w-4/5 mx-auto text-white py-2 px-2 rounded-lg mb-5 mt-5 hover:shadow-lg transition-all font-normal text-xl focus:outline-none"><i class="ri-error-warning-line mr-3 text-xl lg:text-2xl"></i>Por el momento no esta disponible el protocolo completo, intenta comprar ImmuneBioGreenCell individualmente y recibe un 30% de descuento <br><i class="ri-home-heart-fill mr-3 text-xl lg:text-2xl"></i> #QuedateEnCasa</p>-->
                <a :href="protocolos.phase2.linkPhase2" class="flex flex-row flex-wrap justify-center items-center bg-red-600 w-full lg:w-4/5 mx-auto text-white py-4 rounded-lg mb-5 mt-5 hover:shadow-lg hover:bg-black transition-all font-normal text-xl focus:outline-none"><i class="ri-shopping-cart-2-fill mr-3 text-xl lg:text-2xl"></i>Compre Ahora!<span class="ml-2 font-bold text-2xl text-center lg:text-lg lg:text-left w-full lg:w-auto lg:text-3xl">${{price2()}}</span></a>
            </div>
        ...
        <div class="ml-10 mt-5 mb-10">
            ...
            <ul class="ml-5 mt-2">
                <li class="text-base mb-1">• Todo paciente con la condición de diabetes, después de haber comenzado con un protocolo de Immune Bio Green Cell debe monitorear sus niveles de azúcar por lo menos dos veces al día.</li>
                <li class="text-base mb-1">• Consumir la cantidad indicada del producto de acuerdo a la dosis sugerida en la recomendación.</li>
