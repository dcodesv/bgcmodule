    ...
    <div class="flex flex-col justify-center items-center" >
        ...
        <div class="ml-10 mt-5 mb-10">
            ...
            <ul class="ml-5 mt-2">
                ...
                <li class="text-base mb-1">• Consulte con su médico antes de tomar cualquier suplemento dietético, si padece alguna condición médica o si se produce alguna reacción adversa. Las declaraciones sobre los suplementos dietéticos no han sido evaluadas por la FDA y no están destinadas a diagnosticar, tratar, curar o prevenir ninguna enfermedad o problema de salud.</li>
            </ul>
        </div>
        </div>
    </div>
